...
test('renders correctly when passing in empty, then temp, episode data', () => {
...
test('Temp data is reflected on the screen', () => {
    render(<Episodes episodes={episodes} />)

    let episodeOne = screen.queryByText(/Chapter One/i)
    expect(episodeOne).toBeTruthy()
})
